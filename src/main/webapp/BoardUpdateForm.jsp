...
<%
	...
	BoardBean bean = dbao.getOneUpdateBoard(num);
%>
<form action="BoardUpdateProc.jsp" method="post">
	<table width="600" border="1" bgcolor="skyblue">
		...
		<tr height="40">
			...
			<td width="480" colspan="3"><textarea rows="10" cols="60" name="content" align="left"></textarea></td>			
		</tr>
		<tr height="40">
			<td colspan="4" align="center">
			<input type="hidden" name="num" value="<%=bean.getNum() %>">
			<input type="submit" value="글수정">&nbsp; &nbsp;
			<input type="button" onclick="location.href='SessionMain.jsp?center=BoardList.jsp'" value="전체글보기"></td>		
		</tr>
	</table>
</form>
</center>
